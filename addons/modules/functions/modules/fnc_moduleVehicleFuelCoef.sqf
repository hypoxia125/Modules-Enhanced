...
// Variables
//------------------------------------------------------------------------------------------------
private _coef = _module getVariable ["Coef", 0];

// Functions
//------------------------------------------------------------------------------------------------
private _setCoef = {
    params ["_vehicles", "_coef"];

    {
        [QGVAR(VehicleFuelCoef_SetCoef), [_x, _coef], _x] call CBA_fnc_targetEvent;
    } forEach _vehicles;
};
