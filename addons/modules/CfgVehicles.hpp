class CfgVehicles {
    ...
    #include "\z\meh\addons\modules\modules\moduleEarthquakeDamageArea.hpp"
    #include "\z\meh\addons\modules\modules\moduleEarthquakeEpicenter.hpp"
    ...
    #include "\z\meh\addons\modules\modules\moduleFadeScreen.hpp"
